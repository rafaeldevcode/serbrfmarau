<section class="w-full h-[500px] md:h-[700px]" style="background: url(<?php asset("assets/images/{$image}") ?>) no-repeat center; background-size: cover;">
    <div class="bg-[#00000085] w-full h-full flex-col p-4 flex justify-center">
        ...
        <?php isset($show_search) && $show_search ? loadHtml(__DIR__.'/search') : null ?>
    </div>
</section>
