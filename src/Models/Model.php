...
class Model
{
     ...
     * @return stdClass
     */
    public function paginate(int $limit, string $order_column = 'id', string $order_by = 'DESC'): stdClass
    {
        ...
        $query = "SELECT * FROM {$this->table}{$where_clause->clausure} ORDER BY $order_column $order_by LIMIT $start, $limit";
